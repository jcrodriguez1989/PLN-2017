...
if __name__ == '__main__':
    ...
    print("La probabilidad de que el texto de", author1, "sea de", author1,
          "es de", probA1IsA1, "y que sea de", author2, "es de", probA1IsA2,
          "por lo tanto el resultado es", probA1IsA1 > probA1IsA2)
    print("La probabilidad de que el texto de", author2, "sea de", author1,
          "es de", probA2IsA1, "y que sea de", author2, "es de", probA2IsA2,
          "por lo tanto el resultado es", probA2IsA1 < probA2IsA2)
